import '../widgets/listrectangle843_item_widget.dart';
...
class AllPopularTripPackageScreen
  ...
  const AllPopularTripPackageScreen({Key? key}) : super(key: key);
                ...
                Padding(
                  ...
                  child: Obx(
                    () => ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount: controller.allPopularTripPackageModelObj.value
                          .listrectangle843ItemList.length,
                      itemBuilder: (context, index) {
                        final Listrectangle843ItemModel model = controller
